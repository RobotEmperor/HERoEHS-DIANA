...
private:
  ...
  bool setJointFeedBackGainServiceCallback(diana_online_walking_module_msgs::SetJointFeedBackGain::Request  &req,
      diana_online_walking_module_msgs::SetJointFeedBackGain::Response &res);

  bool getReferenceStepDataServiceCallback(diana_online_walking_module_msgs::GetReferenceStepData::Request  &req,
      diana_online_walking_module_msgs::GetReferenceStepData::Response &res);
  bool addStepDataServiceCallback(diana_online_walking_module_msgs::AddStepDataArray::Request  &req,
      diana_online_walking_module_msgs::AddStepDataArray::Response &res);
  bool startWalkingServiceCallback(diana_online_walking_module_msgs::StartWalking::Request  &req,
      diana_online_walking_module_msgs::StartWalking::Response &res);
  bool IsRunningServiceCallback(diana_online_walking_module_msgs::IsRunning::Request  &req,
      diana_online_walking_module_msgs::IsRunning::Response &res);
  bool removeExistingStepDataServiceCallback(diana_online_walking_module_msgs::RemoveExistingStepData::Request  &req,
      diana_online_walking_module_msgs::RemoveExistingStepData::Response &res);

  int convertStepDataMsgToStepData(diana_online_walking_module_msgs::StepData& src, robotis_framework::StepData& des);
  int convertStepDataToStepDataMsg(robotis_framework::StepData& src, diana_online_walking_module_msgs::StepData& des);

  void setBalanceParam(diana_online_walking_module_msgs::BalanceParam& balance_param_msg);
  ...
  void setJointFeedBackGain(diana_online_walking_module_msgs::JointFeedBackGain& msg);
  ...
  diana_online_walking_module_msgs::WalkingJointStatesStamped walking_joint_states_msg_;

  diana_online_walking_module_msgs::RobotPose  robot_pose_msg_;
  ...
  diana_online_walking_module_msgs::JointFeedBackGain previous_joint_feedback_gain_;
  diana_online_walking_module_msgs::JointFeedBackGain current_joint_feedback_gain_;
  diana_online_walking_module_msgs::JointFeedBackGain desired_joint_feedback_gain_;

  diana_online_walking_module_msgs::BalanceParam previous_balance_param_;
  diana_online_walking_module_msgs::BalanceParam current_balance_param_;
  diana_online_walking_module_msgs::BalanceParam desired_balance_param_;
